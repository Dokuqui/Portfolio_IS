...
export const staticProjects: Project[] = [
    ...
    { name: "Magic Tray", description: "A system tray app, refactoring to Rust.", language: ["C", "Rust"], html_url: "https://github.com/Dokuqui/MagicTray", homepage: "http://0.0.0.0:3000", stargazers_count: 0, forks_count: 0 },
    { name: "Hooly Back End", description: "Backend for a project management tool.", language: ["Node.js", "MongoDB"], html_url: "https://github.com/Dokuqui/Hooly_Back-end", homepage: "http://0.0.0.0:3000", stargazers_count: 0, forks_count: 0 },
];